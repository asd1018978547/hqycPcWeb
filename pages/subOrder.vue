      ...
      <div class="container white-bg">
              ...
              <template v-for="(ite, index) in listData">
                ...
                >
                  ...
                  <td style="vertical-align:middle">
                    ¥{{ parseFloat(item.PriceWithTax).toFixed(2) }}
                  </td>
        ...
        <div class="top marginTop20">
          ...
          <div class="allPrice">
            ...
            <p>
              运费 ({{ TotalGrossWeight.toFixed(2) }} kg)

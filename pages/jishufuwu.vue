    ...
    <div class="about_cont">
      ...
      <div class="about_right">
        ...
        <div class="about_content">
          <p class="title">· 技术团队</p>
          <p>环球云仓的技术研发和产品运营团队核心成员均来自阿里巴巴、携程网、慧聪网、敦煌网等知名电商、产业互联网企业，在跨境电商领域拥有强大的产品研发能力及深厚的运营服务经验。</p>
          <p class="title">· 系统对接</p>
          <p>环球云仓与行业知名跨境电商平台（天猫国际、京东海囤全球、考拉海购、海拍客、渝欧汇等），以及第三方支付（支付宝、微信、通联支付等）、电子口岸（成都）、第三方物流（中通、韵达等）等各类平台完成了系统对接，具备全面、完备、安全的“电商平台+支付+清关+物流+结算”技术对接和业务打通能力。</p>
          <p class="title">· SAAS服务</p>
          <p>服务即将上线，敬请关注！</p>
        </div>
      </div>
    </div>

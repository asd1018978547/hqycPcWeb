    ...
    <div class="about_cont">
      ...
      <div class="about_right">
        ...
        <div class="about_content">
          <p class="title"> 环球云仓国际贸易（成都）有限公司（简称“环球云仓”）是澳大利亚布里斯班My Healthy Garden（MHG）公司在成都设立的跨境电商平台公司，于2017年12月在四川成都双流自由贸易试验区注册成立，全面承接MHG供应链业务在中国区的营销推广，在中国境内开展跨境电商供应链服务。</p>
          <p class="title">环球云仓拥有澳洲海外仓与成都自建保税仓，与海关系统完成了对接，支持国内保税仓发货、BC直邮等多种模式。</p>
        </div>
      </div>
    </div>
    <v-bottom></v-bottom>

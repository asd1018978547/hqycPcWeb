  ...
  <div class="main">
    ...
    <div class="tableCon marginTop20" v-if=" AUTHTYPE == 1">
      <div class="container white-bg">
        ...
        <div class="failStyle">
          审核未通过
          <span v-if="FailReason1!=''">：{{FailReason1}}</span>
        </div>
        <el-form
          :model="s_1"
          :rules="s_1_rules"
        ...
        >
          <div style="display: flex;flex-wrap: wrap;box-sizing: border-box;">
            ...
            <div style="width:48%; margin: 0 0 0 0;">
            ...
            <el-form-item style=" margin: 10px 0 0 0;">
              ...
              <el-button @click="resetForm('ruleForm')">切换认证类型</el-button>
            </el-form-item>
          </div>
        </el-form>
      </div>

          ...
          >
            ...
            <div v-if="this.jnf!='丢件'&&this.jnf!='订单发货超时'&&this.jnf!=''">
              ...
              >
                <ul>
                  <li>
                    <span class="span_import" v-if="this.jnf=='瘪罐（仅奶粉）'">*</span>
                    <span style="color: #333333;" v-if="this.jnf=='瘪罐（仅奶粉）'">6.气泡柱照片</span>
      ...
      this.$refs[formName].validate(valid => {
        ...
        if (this.ProTotalPrice == 0) {
          ...
          if (
            ...
            if (valid) {
              API.editPayBack(params).then(res => {
                if (res.ResponseId != 0) {
                  self.btnFlag = false;
                  this.isLoginOut(res);
                } else {
    ...
    getData() {
      ...
      API.getPayBackDetail(para).then(res => {
        if (res.ResponseId != 0) {
          ...
          this.ProTotalPrice = Number(self.baseInfo.RefundGoodsTotalAmount);
          if (self.baseInfo.RefundReasonCode == "RRC001") {
            if (self.baseInfo.RefundOrderDetails[0].DamageTenCount) {
              this.RefundStandards.push({
                RefundStandardCode: "RSC001",
                OrderDetailId:
                  self.baseInfo.RefundOrderDetails[0].OrderDetailId,
                ProId: self.baseInfo.RefundOrderDetails[0].ProId,
                ProCount: self.baseInfo.RefundOrderDetails[0].DamageTenCount
              });
            }
            if (self.baseInfo.RefundOrderDetails[0].DamageTenToThirtyCount) {
              this.RefundStandards.push({
                RefundStandardCode: "RSC002",
                OrderDetailId:
                  self.baseInfo.RefundOrderDetails[0].OrderDetailId,
                ProId: self.baseInfo.RefundOrderDetails[0].ProId,
                ProCount:
                  self.baseInfo.RefundOrderDetails[0].DamageTenToThirtyCount
              });
            }
            if (self.baseInfo.RefundOrderDetails[0].DamageThirtyToFiftyCount) {
              this.RefundStandards.push({
                RefundStandardCode: "RSC003",
                OrderDetailId:
                  self.baseInfo.RefundOrderDetails[0].OrderDetailId,
                ProId: self.baseInfo.RefundOrderDetails[0].ProId,
                ProCount:
                  self.baseInfo.RefundOrderDetails[0].DamageThirtyToFiftyCount
              });
            }
            //10%
            setTimeout(() => {
              this.lv1 = parseInt(
                self.baseInfo.RefundOrderDetails[0].DamageTenCount
              );
              this.value1 = parseInt(
                self.baseInfo.RefundOrderDetails[0].DamageTenCount
              );
              this.cout10 = parseInt(
                self.baseInfo.RefundOrderDetails[0].DamageTenCount
              );
              //10-30
              this.lv2 = parseInt(
              ...
              this.cout10_30 = parseInt(
                self.baseInfo.RefundOrderDetails[0].DamageTenToThirtyCount
              );
              //30-50
              this.value3 = parseInt(
                self.baseInfo.RefundOrderDetails[0].DamageThirtyToFiftyCount
              );
              this.lv3 = parseInt(
                self.baseInfo.RefundOrderDetails[0].DamageThirtyToFiftyCount
              );
              this.cout30_50 = parseInt(
                self.baseInfo.RefundOrderDetails[0].DamageThirtyToFiftyCount
              );
            }, 200);
          } else if (self.baseInfo.RefundReasonCode == "RRC002") {
            //损坏
            if (self.baseInfo.RefundOrderDetails[0].SlightDamageCount) {
              this.RefundStandards.push({
                RefundStandardCode: "RSC004",
                OrderDetailId:
                  self.baseInfo.RefundOrderDetails[0].OrderDetailId,
                ProId: self.baseInfo.RefundOrderDetails[0].ProId,
                ProCount: self.baseInfo.RefundOrderDetails[0].SlightDamageCount
              });
            }
            if (self.baseInfo.RefundOrderDetails[0].ModerateDamageCount) {
              this.RefundStandards.push({
                RefundStandardCode: "RSC005",
                OrderDetailId:
                  self.baseInfo.RefundOrderDetails[0].OrderDetailId,
                ProId: self.baseInfo.RefundOrderDetails[0].ProId,
                ProCount:
                  self.baseInfo.RefundOrderDetails[0].ModerateDamageCount
              });
            }
            if (self.baseInfo.RefundOrderDetails[0].SeriousDamageCount) {
              this.RefundStandards.push({
                RefundStandardCode: "RSC006",
                OrderDetailId:
                  self.baseInfo.RefundOrderDetails[0].OrderDetailId,
                ProId: self.baseInfo.RefundOrderDetails[0].ProId,
                ProCount: self.baseInfo.RefundOrderDetails[0].SeriousDamageCount
              });
            }
            //轻
            setTimeout(() => {
              this.lv1 = parseInt(
                self.baseInfo.RefundOrderDetails[0].SlightDamageCount
              );
              this.value1 = parseInt(
                self.baseInfo.RefundOrderDetails[0].SlightDamageCount
              );
              ...
              //重
              this.value3 = parseInt(
                self.baseInfo.RefundOrderDetails[0].SeriousDamageCount
              );
              this.lv3 = parseInt(
                self.baseInfo.RefundOrderDetails[0].SeriousDamageCount
              );
              this.damageCout1 = parseInt(
                self.baseInfo.RefundOrderDetails[0].SlightDamageCount
              );
              this.damageCout2 = parseInt(
                self.baseInfo.RefundOrderDetails[0].ModerateDamageCount
              );
              this.damageCout3 = parseInt(
                self.baseInfo.RefundOrderDetails[0].SeriousDamageCount
              );
            }, 200);
          } else if (self.baseInfo.RefundReasonCode == "RRC010") {
            //商品瑕疵--退货退款
            this.RefundStandards.push({
              RefundStandardCode: "RSC016",
              OrderDetailId: self.baseInfo.RefundOrderDetails[0].OrderDetailId,
              ProId: self.baseInfo.RefundOrderDetails[0].ProId,
              ProCount: self.baseInfo.RefundOrderDetails[0].ProCount
            });
            setTimeout(() => {
              this.spxcCout = parseInt(
                self.baseInfo.RefundOrderDetails[0].RefundCount
              );
            }, 200);
          } else if (self.baseInfo.RefundReasonCode == "RRC009") {
            //包装破损--退货退款
            this.RefundStandards.push({
              RefundStandardCode: "RSC015",
              OrderDetailId: self.baseInfo.RefundOrderDetails[0].OrderDetailId,
            ...
            setTimeout(() => {
              this.bzpsCout = parseInt(
                self.baseInfo.RefundOrderDetails[0].RefundCount
              );
            }, 200);
          } else if (self.baseInfo.RefundReasonCode == "RRC008") {
            //爆罐--退货退款
            this.RefundStandards.push({
              RefundStandardCode: "RSC014",
              OrderDetailId: self.baseInfo.RefundOrderDetails[0].OrderDetailId,
            ...
            setTimeout(() => {
              this.bgCout = parseInt(
                self.baseInfo.RefundOrderDetails[0].RefundCount
              );
            }, 200);
          } else if (self.baseInfo.RefundReasonCode == "RRC011") {
            //商品保质期与平台描述不符--退货退款
            this.RefundStandards.push({
              RefundStandardCode: "RSC017",
              OrderDetailId: self.baseInfo.RefundOrderDetails[0].OrderDetailId,
            ...
            setTimeout(() => {
              this.ptbzqCout = parseInt(
                self.baseInfo.RefundOrderDetails[0].RefundCount
              );
            }, 200);
          } else if (self.baseInfo.RefundReasonCode == "RRC012") {
            //错发--退货退款
            this.RefundStandards.push({
              RefundStandardCode: "RSC018",
              OrderDetailId: self.baseInfo.RefundOrderDetails[0].OrderDetailId,
            ...
            setTimeout(() => {
              this.cfCout = parseInt(
                self.baseInfo.RefundOrderDetails[0].RefundCount
              );
            }, 200);
          } else if (self.baseInfo.RefundReasonCode == "RRC003") {
            //商品瑕疵--申请补偿
            this.RefundStandards.push({
              RefundStandardCode: "RSC007",
              OrderDetailId: self.baseInfo.RefundOrderDetails[0].OrderDetailId,
            ...
            setTimeout(() => {
              this.xcCout = parseInt(
                self.baseInfo.RefundOrderDetails[0].RefundCount
              );
            }, 200);
          } else if (self.baseInfo.RefundReasonCode == "RRC005") {
            //丢件--仅补偿
            this.RefundStandards.push({
              RefundStandardCode: "RSC011",
              OrderDetailId: self.baseInfo.RefundOrderDetails[0].OrderDetailId,
            ...
            setTimeout(() => {
              this.djCout = parseInt(
                self.baseInfo.RefundOrderDetails[0].RefundCount
              );
            }, 200);
          } else if (self.baseInfo.RefundReasonCode == "RRC016") {
            //订单发货超时--申请补偿
            this.RefundStandards.push({
              RefundStandardCode: "RSC022",
              OrderDetailId: self.baseInfo.RefundOrderDetails[0].OrderDetailId,
          ...
          } else if (self.baseInfo.RefundReasonCode == "RRC006") {
            //少件--仅退款
            this.RefundStandards.push({
              RefundStandardCode: "RSC012",
              OrderDetailId: self.baseInfo.RefundOrderDetails[0].OrderDetailId,
          ...
          } else if (self.baseInfo.RefundReasonCode == "RRC007") {
            //拒收--仅退款
            this.RefundStandards.push({
              RefundStandardCode: "RSC013",
              OrderDetailId: self.baseInfo.RefundOrderDetails[0].OrderDetailId,
            ...
            setTimeout(() => {
              ...
              //低于平台有效期数量
              this.lv1 = parseInt(
                self.baseInfo.RefundOrderDetails[0]
                  .LowerThanPlatformValidityPeriodCount
              );
              this.value1 = parseInt(
                self.baseInfo.RefundOrderDetails[0]
                  .LowerThanPlatformValidityPeriodCount
              ...
              this.lv2 = parseInt(
                self.baseInfo.RefundOrderDetails[0]
                  .LowerThanTotalValidityPeriodCount
              );
              this.value2 = parseInt(
                self.baseInfo.RefundOrderDetails[0]
                  .LowerThanTotalValidityPeriodCount
              );
              this.dyptyxq = parseInt(
                self.baseInfo.RefundOrderDetails[0]
                  .LowerThanPlatformValidityPeriodCount
              );
              this.dyzyxq = parseInt(
                self.baseInfo.RefundOrderDetails[0]
                  .LowerThanTotalValidityPeriodCount
              );
            }, 200);
          ...
          if (
            self.baseInfo.RefundOrderDetails[0].BatchNumberOrExpiryDateImage
          ) {
            this.isShow5 = false;
            this.url5Show =
              this.imgBaseUrl +
          ...
          if (self.baseInfo.RefundOrderDetails[0].ExpressDeliverySheetImage) {
            this.isShow1 = false;
            this.url1Show =
              this.imgBaseUrl +
              self.baseInfo.RefundOrderDetails[0].ExpressDeliverySheetImage;
            this.ExpressDeliverySheetImage =
              self.baseInfo.RefundOrderDetails[0].ExpressDeliverySheetImage;
          }
          if (self.baseInfo.RefundOrderDetails[0].ExpressboxImage) {
            this.isShow2 = false;
            this.url2Show =
              this.imgBaseUrl +
              self.baseInfo.RefundOrderDetails[0].ExpressboxImage;
            this.ExpressboxImage =
              self.baseInfo.RefundOrderDetails[0].ExpressboxImage;
          }
          if (self.baseInfo.RefundOrderDetails[0].DamagedImage) {
            this.isShow3 = false;
            this.url3Show =
              this.imgBaseUrl +
              self.baseInfo.RefundOrderDetails[0].DamagedImage;
            this.DamagedImage =
              self.baseInfo.RefundOrderDetails[0].DamagedImage;
          }
          if (self.baseInfo.RefundOrderDetails[0].MerchandiseFrontImage) {
            this.isShow4 = false;
            this.url4Show =
              this.imgBaseUrl +
              self.baseInfo.RefundOrderDetails[0].MerchandiseFrontImage;
            this.MerchandiseFrontImage =
              self.baseInfo.RefundOrderDetails[0].MerchandiseFrontImage;
          }
          if (self.baseInfo.RefundOrderDetails[0].CartonImage) {
            this.isShow6 = false;
            this.url6Show =
              this.imgBaseUrl + self.baseInfo.RefundOrderDetails[0].CartonImage;
            this.CartonImage = self.baseInfo.RefundOrderDetails[0].CartonImage;
          }
          if (self.baseInfo.RefundOrderDetails[0].UnpackingImage) {
            this.isShow7 = false;
            this.url7Show =
              this.imgBaseUrl +
              self.baseInfo.RefundOrderDetails[0].UnpackingImage;
            this.UnpackingImage =
              self.baseInfo.RefundOrderDetails[0].UnpackingImage;
          }
          self.OrderCode = self.baseInfo.OrderCode;
          self.ProId = self.baseInfo.RefundOrderDetails[0].ProId;
          this.ruleForm.resasonDesc = self.baseInfo.RefundExplain;
          this.ruleForm.serviceType = self.baseInfo.RefundMethodDesc;
          this.RefundMethodCode = self.baseInfo.RefundMethodCode;
          this.RefundMethodDesc = self.baseInfo.RefundMethodDesc;
          this.RefundReasonCode = self.baseInfo.RefundReasonCode;
          this.RefundReasonDesc = self.baseInfo.RefundReasonDesc;
          self.baseInfoDetial = res.Data.RefundOrderDetails[0];
          self.ProId = res.Data.RefundOrderDetails[0].ProId;
          this.ruleForm.reason = self.baseInfo.RefundReasonDesc;
          setTimeout(() => {
            switch (self.baseInfo.RefundReasonCode) {
              case "RRC001":
                this.jnf = "瘪罐（仅奶粉）";
                break;
              case "RRC002":

    ...
    >
      <div class="container white-bg" style="padding:20px;">
        ...
        <el-row :gutter="12">
          ...
          >
            <el-card title="适用于微商、代购一族认证" class="auth_card" :class="getClass(1)" shadow="hover">
              <span>微商代购认证</span>
              <span
          ...
          >
            <el-card
              title="适用于已在其他平台（天猫、京东等）上开店的商户认证"
              class="auth_card"
              :class="getClass(2)"
              shadow="hover"
            >
          ...
          >
            <el-card title="适用于线下实体店铺主认证" class="auth_card" :class="getClass(3)" shadow="hover">
              <span title="适用于线下实体店铺主认证">实体门店认证</span>
          ...
          >
            <el-card title="适用于已有自己专属平台的商户认证" class="auth_card" :class="getClass(4)" shadow="hover">
              <span>网络平台认证</span>
              <span
          ...
          >
            <el-card title="适用于中小型批发商户认证" class="auth_card" :class="getClass(6)" shadow="hover">
              <span>批采企业认证</span>
              <span
        ...
        <div class="Certification_tips">
          <p style="margin-bottom:10px">认证说明：</p>
          <p>1、完成认证后，您的账号和资金的安全性将得到更好的保障。</p>
          <p>2、我们会根据您的认证类型推出对应的活动。</p>
          <p>3、我们会根据您的认证类型提供针对性的品类和商品选取与支持。</p>
          <p>4、您将在我们平台建立完善的会员等级和信用制度后，享受更优质的价格和服务。</p>
        </div>
      </div>
    </div>
    <!-- 微商代购 -->
          ...
          <div style="display: flex;flex-wrap: wrap;box-sizing: border-box;">
            <div style="width:48%">
              <el-form-item label="微商名称:" prop="shopName" label-width="150px">
                <el-input v-model="s_1.shopName" placeholder="请填写微商名称" style="width:80%"></el-input>
              </el-form-item>
            </div>
            <div style="width:48%">
            ...
            <div style="width:48%; margin: 10px 0 0 0;">
              <el-form-item label="身份证号码:" label-width="150px" prop="idCardNo">
                <el-input v-model="s_1.idCardNo" placeholder="请填写身份证号码" style="width:80%"></el-input>
              </el-form-item>
            </div>
          ...
          <div style="display: flex;flex-wrap: wrap;box-sizing: border-box;">
            <div style="width:48%">
              <el-form-item label="店铺名称:" prop="shopName" label-width="150px">
                <el-input v-model="s_2.shopName" placeholder="请填写店铺名称" style="width:80%"></el-input>
              </el-form-item>
            </div>
            <div style="width:48%">
              <el-form-item label="销售平台:" prop="platform" label-width="150px">
                <el-input v-model="s_2.platform" placeholder="请填写销售平台" style="width:80%"></el-input>
              </el-form-item>
            </div>
            <div style="width:48%; margin: 10px 0 0 0;">
              <el-form-item label="店铺网址:" prop="webLink" label-width="150px">
                <el-input v-model="s_2.webLink" placeholder="请填写店铺网址" style="width:80%"></el-input>
              </el-form-item>
            </div>
            <div style="width:48%; margin: 10px 0 0 0;">
              <el-form-item label="经营类目:" label-width="150px">
          ...
          <div style="display: flex;flex-wrap: wrap;box-sizing: border-box;">
            <div style="width:48%">
              <el-form-item label="门店名称:" prop="shopName" label-width="150px">
                <el-input v-model="s_3.shopName" placeholder="请输入门店名称" style="width:80%"></el-input>
              </el-form-item>
            </div>
            <div style="width:48%">
            ...
            <div style="width:48%; margin: 10px 0 0 0;">
              <el-form-item label="详细地址:" prop="address" label-width="150px">
                <el-input v-model="s_3.address" placeholder="请填写详细地址" style="width:80%"></el-input>
              </el-form-item>
            </div>
            <div style="width:48%; margin: 10px 0 0 0;">
              <el-form-item label="经营类目:" label-width="150px">
            ...
            <div style="width:48%; margin: 10px 0 0 0;">
              <el-form-item label="营业执照号码:" label-width="150px" prop="license">
                <el-input v-model="s_3.license" placeholder="请填写营业执照号码" style="width:80%"></el-input>
              </el-form-item>
            </div>
            <div style="width:80%"></div>
            <div style="width:48%; margin: 10px 0 0 0;">
          ...
          <div style="display: flex;flex-wrap: wrap;box-sizing: border-box;">
            <div style="width:48%">
              <el-form-item label="企业名称:" prop="companyName" label-width="150px">
                <el-input v-model="s_4.companyName" placeholder="请输入企业名称" style="width:80%"></el-input>
              </el-form-item>
            </div>
            <div style="width:48%">
              <el-form-item label="平台名称:" prop="shopName" label-width="150px">
                <el-input v-model="s_4.shopName" placeholder="请输入平台名称" style="width:80%"></el-input>
              </el-form-item>
            </div>
            <div style="width:48%; margin: 10px 0 0 0;">
              <el-form-item label="平台网址:" prop="webLink" label-width="150px">
                <el-input v-model="s_4.webLink" placeholder="请输入平台网址" style="width:80%"></el-input>
              </el-form-item>
            </div>
            <div style="width:48%; margin: 10px 0 0 0;">
              <el-form-item label="经营类目:" label-width="150px">
      ...
      <div class="container white-bg">
        ...
        >
          <div style="display: flex;flex-wrap: wrap;box-sizing: border-box;">
            <div style="width:48%">
              <el-form-item label="企业名称:" prop="companyName" label-width="150px">
                <el-input v-model="s_6.companyName" placeholder="请输入企业名称" style="width:80%"></el-input>
              </el-form-item>
            </div>
            <div style="width:48%">
            ...
            <div style="width:48%; margin: 10px 0 0 0;">
              <el-form-item label="详细地址:" prop="address" label-width="150px">
                <el-input v-model="s_6.address" placeholder="请填写详细地址" style="width:80%"></el-input>
              </el-form-item>
            </div>
            <div style="width:48%; margin: 10px 0 0 0;">
              <el-form-item label="经营类目:" label-width="150px">
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          if (this.selectedIndex == 4 || this.selectedIndex == 6) {
            ...
            if (
            this["s_" + this.selectedIndex].sales <= 0 &&
            this["s_" + this.selectedIndex].sales != ""
          ) {
            this.$message.error("月销量必须大于0");
            return;
          }
          this["s_" + this.selectedIndex].token = JSON.parse(
    ...
    API.authResult({
      ...
      if (res.Data.Status) {
        if (res.Data.Status == 1) {
          this.$router.push({ path: "/authDetail" });
        }
      }
    });
    // let retailerAuthStatus = JSON.parse(window.localStorage.getItem("user"))
    //   .retailerAuthStatus;
    this.uploadUrl =
      _CONFIG.fileUrl +

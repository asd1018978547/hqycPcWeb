    ...
    <div class="about_cont">
      ...
      <div class="about_right">
        ...
        <div class="about_content">
          <p class="title">环球云仓依托自身与电子口岸、第三方物流等各方实现系统对接、流畅运转的技术能力，以及“成都自建保税仓+澳洲海外仓”的仓储发货能力等等，为客户提供及时、高效、稳定的清关、物流服务。</p>
          <p class="title">· 7X24小时阳光清关</p>
          <p class="title">· 成都保税仓发货2-3个工作日送达</p>
          <p class="title">· BC直邮7个工作日送达</p>
        </div>
      </div>
    </div>
    <v-bottom></v-bottom>
